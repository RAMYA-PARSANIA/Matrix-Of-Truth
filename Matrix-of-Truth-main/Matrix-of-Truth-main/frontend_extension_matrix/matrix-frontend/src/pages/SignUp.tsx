...
import { Shield, Eye, Mail, Lock, User } from "lucide-react";
...
const SignUp = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative flex items-center justify-center py-12">
        ...
        <div className="w-full max-w-md relative z-10 px-4">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              >
                Create your Matrix of Truth account
              </motion.p>
            </div>
            ...
            >
              <div className="grid grid-cols-3 gap-3 text-center">
                <div className="p-3 bg-slate-900/50 rounded-lg">
                  <Shield className="text-red-400 mx-auto mb-2" size={16} />
                  <p className="text-xs text-slate-400">Secure</p>
                </div>
                <div className="p-3 bg-slate-900/50 rounded-lg">
                  <Eye className="text-orange-400 mx-auto mb-2" size={16} />
                  <p className="text-xs text-slate-400">AI-Powered</p>
                </div>
                <div className="p-3 bg-slate-900/50 rounded-lg">
                  <User className="text-yellow-400 mx-auto mb-2" size={16} />
